...
```
### Функция-генератор
Также если заключить конструкцию __for__ между круглыми скобками (вместо квадратных), то получим
функцию-генератор
```python3
...
[[y for y in range(x, x + 4)] for x in range(1, 17, 4)]
...
* №3059 (https://informatics.msk.ru/mod/statements/view3.php?id=249&chapterid=3059)
По желанию:
