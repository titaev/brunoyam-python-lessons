...
## 1.  [Введение в Python](1. Indtroduction to Python.md)
* [Общая информация о курсе](1. Indtroduction to Python.md#1-общая-информация-о-курсе)
* [Что такое Python?](1. Indtroduction to Python.md#2-что-такое-python)
* [Настройка Python, PyCharm](1. Indtroduction to Python.md#3-настройка-python-pycharm)
* [Первая программа, синтаксис](1. Indtroduction to Python.md#4-первая-программа-синтаксис)
* [Самостоятельная работа](1. Indtroduction to Python.md#5-самостоятельная-работа)
* [Условные операторы](1. Indtroduction to Python.md#6-условные-операторы)
* [Самостоятельная работа](1. Indtroduction to Python.md#7-самостоятельная-работа)
* [Домашняя работа](1. Indtroduction to Python.md#8-домашняя-работа)
