...
### 2
- Переменная. Имя переменной (лат символы, цифры, нижние подчеркивания. Не может содержать пробелов и начинаться с числа. Также необходимо называть правильно а "login" а не "ааа") Языки статически типизированные (нужно указывать тип, нельзя менять тип) (плюсы; скорость) и динамически типизированные (можно менять тип, не нужно указывать тип). 
